...
void test_yields(void ** state)
{
    ...
    /* 0.936977 for the Chabrier (2003) lognormal with sigma = 0.69 in log10.
     * The old expected value, 0.624632, was the normalisation of the natural-log
     * form that chabrier_imf used before the log10 fix. */
    assert_true(fabs(imf_norm - 0.936977) <  0.01);
